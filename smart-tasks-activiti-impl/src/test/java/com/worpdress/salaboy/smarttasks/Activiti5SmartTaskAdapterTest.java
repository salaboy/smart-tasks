...
import com.worpdress.salaboy.smarttasks.activiti5wrapper.Activiti5AuthorizedTaskOperations;
...
public class Activiti5SmartTaskAdapterTest {
    ...
    public void setUp() {
        ...
        initSampleTask();
        HumanTaskClientRegistry.getInstance().addQueryClient("Activiti5Query", new Activiti5AuthorizedTaskOperations(taskService, formService));
